       ...
       <div class="main-menu-content">
              ...
              <li class="nav-item  open ">
                     ...
                     <li class="active"><a class="menu-item" href="{{route('AllUsers')}}"
                                          data-i18n="nav.dash.ecommerce"> Show All </a>
                     </li>
                     <li><a class="menu-item" href="#" data-i18n="nav.dash.crypto">Add User</a>
                     </li>
                     </ul>
              </li>
              ...
              <li class="nav-item"><a href=""><i class="la la-group"></i>
                     <span class="menu-title" data-i18n="nav.dash.main"> friends </span>
                     <span
